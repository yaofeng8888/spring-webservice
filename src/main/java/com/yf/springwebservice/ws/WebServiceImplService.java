 ...
 * 
 */
@WebServiceClient(name = "WebServiceImplService", targetNamespace = "WSDL", wsdlLocation = "http://127.0.0.1:8099/WS_Server/WebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEBSERVICEIMPLSERVICE_QNAME = new QName("WSDL", "WebServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://127.0.0.1:8099/WS_Server/WebService?wsdl");
    ...
    public WebServiceImpl getWebServiceImplPort() {
        return super.getPort(new QName("WSDL", "WebServiceImplPort"), WebServiceImpl.class);
    }
    ...
    public WebServiceImpl getWebServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("WSDL", "WebServiceImplPort"), WebServiceImpl.class, features);
    }
